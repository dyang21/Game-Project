...
class player(pg.sprite.Sprite):
    ...
    def move(self): #keypresses
        """
        parameters: none
        increases the class attribute for the playermovement based on the user's current action 
        returns none
        """
    ...
    def new_action(self,old_action,frame_value,new_action):
        """
        parameters: str, int, str
        changes the player action; resets fram value
        returns the changed old action and resetted frame value
        """
    ...
    def update(self):
        """
        parameters: none
        changes the player animation and frame in accordance with their movement
        returns none
        """
        self.player_movement[0] -= self.horiDiff
    ...
    def boundaries(self):
        """
        parameters: none
        sets bottom, right, and left boundaries for the player to not cross
        returns none
        """
